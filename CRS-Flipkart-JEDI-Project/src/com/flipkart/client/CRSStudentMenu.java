...
//						System.out.println(courseIdAlternate);
						...
						user = UserOperation.getInstance();
						courseCatalog = user.getCourseCatalog(student.getSemester());
						
						System.out.println("The Primary courses chosen are: ");
						for(Integer id:courseIdPrimary) {
							for(Course course:courseCatalog) {
								if(course.getCourseId()==id) {
									System.out.printf("%-25d. %-20s %-20s\n",course.getCourseId(),course.getCourseCode(),course.getCourseName());
								}
							}
						}
						System.out.println();
						
						System.out.println("The Alternate courses chosen are: ");
